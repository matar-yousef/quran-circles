    ...
    <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between mb-4 pb-3 border-bottom gap-3">
        <div>
            <h1 class="h3 fw-bold text-dark mb-1 font-cairo">
                <i class="bi bi-person-plus-fill text-success me-2"></i> إضافة طالب جديد
            </h1>
            <p class="text-muted small mb-0 font-system">قم بإدخال بيانات الطالب الجديدة بدقة لضمان تسجيلها في النظام بنجاح.</p>
        </div>
    ...
    <form action="{{ route('student.store') }}" method="POST" class="needs-validation" novalidate>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control bg-light @error('full_name') is-invalid @enderror" id="full_name" name="full_name" required value="{{ old('full_name') }}" placeholder="أدخل اسم الطالب رباعياً" style="font-size: 0.9rem;">
                    </div>
                    @error('full_name')
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control bg-light @error('student_id_number') is-invalid @enderror" id="student_id_number" name="student_id_number" required value="{{ old('student_id_number') }}" placeholder="9 أرقام" style="font-size: 0.9rem;">
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control bg-light @error('address') is-invalid @enderror" id="address" name="address" required value="{{ old('address') }}" placeholder="المدينة / المنطقة / الحي" style="font-size: 0.9rem;">
                    </div>
                    @error('address')
                    <div class="text-danger small mt-1">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" class="form-control bg-light @error('birth_date') is-invalid @enderror" id="birth_date" name="birth_date" required value="{{ old('birth_date') }}" style="font-size: 0.9rem;">
                    </div>
                    @error('birth_date')
                    <div class="text-danger small mt-1">{{ $message }}</div>
                    @enderror
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control bg-light @error('father_full_name') is-invalid @enderror" id="father_full_name" name="father_full_name" required value="{{ old('father_full_name') }}" placeholder="اسم الأب" style="font-size: 0.9rem;">
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control bg-light @error('father_id_number') is-invalid @enderror" id="father_id_number" name="father_id_number" required value="{{ old('father_id_number') }}" placeholder="رقم الهوية" style="font-size: 0.9rem;">
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="tel" class="form-control bg-light @error('guardian_phone') is-invalid @enderror" id="guardian_phone" name="guardian_phone" required value="{{ old('guardian_phone') }}" placeholder="059xxxxxxx" style="font-size: 0.9rem;">
                    </div>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control bg-light @error('current_juz') is-invalid @enderror" id="current_juz" name="current_juz" min="1" max="30" required value="{{ old('current_juz') }}" placeholder="من 1 إلى 30" style="font-size: 0.9rem;">
                    </div>
                    @error('current_juz')
                    <div class="text-danger small mt-1">{{ $message }}</div>
                    @enderror
        ...
        <div class="d-flex flex-wrap justify-content-start gap-2 mt-4">
            <button type="submit" class="btn btn-success px-5 py-2.5 rounded-pill fw-bold shadow-sm font-cairo" style="font-size: 0.95rem;">
                <i class="bi bi-check-lg ms-1"></i> حفظ بيانات الطالب
            </button>
